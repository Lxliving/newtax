...
<body>
		...
		<div class="daohang">
			<ul id="tabs_nav"
				...
				<form action="">
					<li class="top_search">
						<div class="search">
							<a href="webPages/zixun/find.jsp"> <img alt=""
								src="image/icon/fdj.png" class="fangdajing">
		...
		<div class="user">
			<div class="user_content">
				...
				<%
					if (username == null) {
						out.println(
								"<a href=\"webPages/jiedu/login.jsp\" style=\"padding: 0 50px;\"> <img src=\"image/header/u198.png\" class=\"person\">\n");
						out.println("</a>\n");
						...
						out.println(
								"<a href=\"webPages/usercenter/MyIntro.jsp\" style=\"padding: 0 50px;\"> <img src=\"image/header/u198.png\" class=\"person\">\n");
						out.println("</a>\n");
						out.println("<div style=\"position: absolute; left: 20px; line-height: 0px;\">\n");
						out.println("<div style=\"line-height: 13px;\">\n");
	...
	<div class="dialog">
		...
		<div class="title">
			<img alt="点击可以关闭" src="image/icon/closepopwinbtn.png" width="20px"
				height="20px;">
		</div>

		<div class="tips_content">
			<img alt="" src="image/tips.png" width="115px" height="115px"
				style="position: absolute; margin-left: 80px; margin-right: 80px; margin-top: 0px;">
...
=======
			...
			<span class="fl">当前位置：<a style="color: black;"
				href="webPages/zixun/question_model.jsp" class="nav_style">咨询</a></span> <span
				class="fl">&nbsp;&gt;&nbsp;</span> <span class="fl"
...
>>>>>>> a4bf238c131463c75b0e4281f0d8530279e21d22
		...
		<div class="ques_content">
			<div class="notsolved">
				<!-- 头部 start -->
				<div class="mark">
					<img src="image/questionmark.png"> <span>未解决</span>
				</div>
...
=======
						<span>内容：</span> <span id="hidden"><p>个人说的税是怎么计算的，流程是什么？</p>
						</span>
>>>>>>> a4bf238c131463c75b0e4281f0d8530279e21d22
					</div>
					<!-- 问题详情 end -->
			...
			<div class="ques_content_three">
				<div class="ques_content_three_nav">
					<ul>
						...
						<li style="cursor: pointer; float: right; cursor: pointer;"
							onclick="report();" class="report">举报</li>
						<li class="star" onclick="star();"
		...
		<div class="ex_ques_PopWinContent">
			<form method="GET" id="sunmitTable">
				<table cellspacing="0" cellpadding="0">
					...
					<tr>
						<td colspan="6"><button type="submit">提交</button></td>
					</tr>
				</table>
			</form>
			...
			<form method="POST" id="editQuestion">
				...
				<table cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td><textarea id="quescontent" name="content"><p>个人说的税是怎么计算的，流程是什么？</p>
</textarea></td>
					</tr>
				</table>
			</form>
...
<%=hasLogined%>
	...
	function showDialog() {
		...
		var left = sclL + (brsw - curw)
		/2; / / 计算对话框居中时的左边距
		var top = sclT + (brsh - curh)
		/2; / / 计算对话框居中时的上边距
