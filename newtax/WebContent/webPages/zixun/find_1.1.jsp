...
System.out.println(arr.get(0).getConsDetail());
System.out.println(arr.get(0).getConsName());
System.out.println(arr.get(0).getSeenNum());
System.out.println(arr.get(0).getKeptNum());
System.out.println(arr.get(0).getAnsNum());
%>
	...
	<div id="quesContent" class="quesContent">
		   ...
		   String cate="";
			 for(int i=0;i<size;i++){
				 ConsDate =arr.get(i).getDate();
				 ConsName =arr.get(i).getConsName();
				 SeenNum=arr.get(i).getSeenNum();
				 ConsDetail =arr.get(i).getConsDetail();
				 KeptNum =arr.get(i).getKeptNum();
				 AnsNum=arr.get(i).getAnsNum();
				 Category=arr.get(i).getCategory();
